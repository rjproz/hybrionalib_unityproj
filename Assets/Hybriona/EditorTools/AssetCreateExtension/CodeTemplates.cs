#if UNITY_EDITOR
//https://bitbucket.org/liortal/code-templates
using System.IO;
using System.Text;
using UnityEditor;
	...
	public class CodeTemplates 
	{
		...
		internal static UnityEngine.Object CreateScript(string pathName, string templatePath)
		{
			...
			if (File.Exists(templatePath))
			{
				...
				templateText = templateText.Replace("#CREATIONDATE#", System.DateTime.Now.ToString());
				templateText = templateText.Replace("#AUTHOR#", System.Environment.UserName);

				string scriptnamespace = "Hybriona";
				if(pathName.Contains("Assets/Hybriona/"))
				{
					if(pathName.Contains("Assets/Hybriona/Hybriona"))
					{
						scriptnamespace = "Hybriona.Private";
					}
					else
					{
						scriptnamespace = "Hybriona";
					}
				}

				else
				{
					scriptnamespace = ProjectMetaData.Instance().scriptnamespace;
				}

				templateText = templateText.Replace("#NAMESPACE#", scriptnamespace);
